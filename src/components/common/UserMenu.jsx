...
import { User, LogOut, Settings, Crown, CreditCard, HelpCircle, Zap, DollarSign, ShieldCheck, BookOpen } from 'lucide-react';
...
export default function UserMenu({ user }) {
    ...
    const getPermissionBadge = () => {
        if (isOwner) return <Badge className="bg-gradient-to-r from-amber-500 to-orange-600 text-white">Owner</Badge>;
        if (isAdmin) return <Badge className="bg-gradient-to-r from-violet-500 to-purple-600 text-white">Administrador</Badge>;
            ...
            <DropdownMenuContent align="end" className="w-64">
                ...
                <DropdownMenuItem 
                    onClick={async () => {
                        ...
                        window.location.href = 'https://reacttohtml.com/';
                    }}
